...
/**
 * Determine if val already present in the list
*/
bool has(int val, std::vector<uint64_t> list);

/**
 * Determine if val already present in the list(int)
*/
bool has_int(int val, std::vector<int> list);


/**
 * Remove the dulpcated element in the vector
*/
...
class MM
{
    ...
    private:
        ...
        /*
        * Helper function that return hashed pixels in given region
        */
        std::vector<int> pixel_helper(const cs225::PNG& input, int xtile, int ytile, int tw, int th);
