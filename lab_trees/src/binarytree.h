...
class BinaryTree
{
    public:
        ...
        // find the max value in node and it's child
        T maxval(Node* node) const;


        // find the min value in node and it's child
        T minval(Node* node) const;

        int OrderedHelper(Node* treenode) const;
